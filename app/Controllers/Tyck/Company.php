...
use App\Models\Tyck\Company_model;
...
class Company extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['active']['basic']['tyck_company'] = true;
        return view('tyck/company/v_company_index', $data);
    }
    ...
    public function save()
    {
        ...
        if ($this->request->getMethod() != 'post') {
            return redirect()->to('/tyck/company');
        }
        $validation =  \Config\Services::validation();
        $valid = [
            'companyID' => [
                'rules' => 'required|is_unique[tyck_company.companyID]',
                'errors' => [
                    'required' => '不允许为空',
                    'is_unique' => '公司ID已用过'
                ]
