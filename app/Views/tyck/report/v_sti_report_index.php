                                    ...
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item">
                                            <div class="custom-control custom-checkbox mt-1">
                                                <input class="custom-control-input choose" type="checkbox" id="sti_id" value="sti_id">
                                                <label for="sti_id" class="custom-control-label">入库编号</label>
                                            </div>
                                            <div class="custom-control custom-checkbox mt-1">
                                                <input class="custom-control-input choose" type="checkbox" id="company" value="company">
                                                <label for="company" class="custom-control-label">公司</label>
                                            </div>
                                            <div class="custom-control custom-checkbox mt-1">
                                                <input class="custom-control-input choose" type="checkbox" id="goods_id" value="goods_id">
                                                <label for="goods_id" class="custom-control-label">物料代码</label>
                                            </div>
                                            <div class="custom-control custom-checkbox mt-1">
                                                <input class="custom-control-input choose" type="checkbox" id="name_type" value="name_type">
                                                <label for="name_type" class="custom-control-label">物料名称与规格编号</label>
                                            </div>
                                            <div class="custom-control custom-checkbox mt-1">
                                                <input class="custom-control-input choose" type="checkbox" id="unit" value="unit">
                                                <label for="unit" class="custom-control-label">单位</label>
                                            </div>
                                            <div class="custom-control custom-checkbox mt-1">
                                                <input class="custom-control-input choose" type="checkbox" id="qty" value="qty">
                                                <label for="qty" class="custom-control-label">入库量</label>
                                            </div>
                                            <div class="custom-control custom-checkbox mt-1">
                                                <input class="custom-control-input choose" type="checkbox" id="location" value="location">
                                                <label for="location" class="custom-control-label">库位</label>
                                            </div>
                                            <div class="custom-control custom-checkbox my-1">
                                                <input class="custom-control-input choose" type="checkbox" id="remark" value="remark">
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <div class="select2-primary">
                                                    <select class="select2-company" id="company" multiple="multiple" data-placeholder="公司筛选（可放空）" data-dropdown-css-class="select2-primary" style="width: 100%;">
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="mt-2">
                                                ...
                                                <div class="select2-primary">
                                                    <select class="select2-goods_id" id="goods_id" multiple="multiple" data-placeholder="物料筛选（可放空）" data-dropdown-css-class="select2-primary" style="width: 100%;">
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="my-2">
                                                ...
                                                <div class="select2-primary">
                                                    <select class="select2-location" id="location" multiple="multiple" data-placeholder="库位筛选（可放空）" data-dropdown-css-class="select2-primary" style="width: 100%;">
                                                    </select>
                                                </div>
                                            </div>
                                        </li>
