...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-6">
                    <form action="<?= base_url('tyck/report/inv_report_adv'); ?>" target="_blank" method="post" id="filterForm">
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <div class="custom-control custom-checkbox mt-1">
                                                    <input class="custom-control-input choose" type="checkbox" name="choosen[]" id="inv_id" value="inv_id">
                                                    <label for="inv_id" class="custom-control-label">库存编号</label>
                                                </div>
                                                <div class="custom-control custom-checkbox mt-1">
                                                ...
                                                <div class="custom-control custom-checkbox mt-1">
                                                    <input class="custom-control-input choose" type="checkbox" name="choosen[]" id="safety" value="safety">
                                                    <label for="safety" class="custom-control-label">安全库存</label>
                                                </div>
                                                <div class="custom-control custom-checkbox mt-1">
...
<script src="<?= base_url('/'); ?>/plugins/inner/tyck/inv_report_index.js"></script>
<?php $this->endSection(); ?>