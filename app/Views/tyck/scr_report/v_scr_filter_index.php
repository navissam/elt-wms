...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-6">
                    <form action="<?= base_url('tyck/report/scr_report_adv'); ?>" target="_blank" method="post" id="filterForm">
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <div class="custom-control custom-checkbox mt-1">
                                                    <input class="custom-control-input choose" type="checkbox" name="choosen[]" id="scr_id" value="scr_id">
                                                    <label for="scr_id" class="custom-control-label">报废编号</label>
                                                </div>
                                                <div class="custom-control custom-checkbox mt-1">
                                                    <input class="custom-control-input choose" type="checkbox" name="choosen[]" id="scr_date" value="scr_date">
                                                    <label for="scr_date" class="custom-control-label">报废日期</label>
                                                </div>
                                                <div class="custom-control custom-checkbox mt-1">
                                                ...
                                                <div class="custom-control custom-checkbox mt-1">
                                                    ...
                                                    <label for="qty" class="custom-control-label">报废数量</label>
                                                </div>
                                                <div class="custom-control custom-checkbox mt-1">
                                                ...
                                                <div class="custom-control custom-checkbox mt-1">
                                                    <input class="custom-control-input choose" type="checkbox" name="choosen[]" id="reason" value="reason">
                                                    <label for="reason" class="custom-control-label">物料报废原因</label>
                                                </div>
                                                <div class="custom-control custom-checkbox mt-1">
                                                    <input class="custom-control-input choose" type="checkbox" name="choosen[]" id="applyPIC" value="applyPIC">
                                                    <label for="applyPIC" class="custom-control-label">申请人</label>
                                                </div>
                                                <div class="custom-control custom-checkbox mt-1">
                                                    <input class="custom-control-input choose" type="checkbox" name="choosen[]" id="verifyPIC" value="verifyPIC">
                                                    <label for="verifyPIC" class="custom-control-label">审核人</label>
                                                </div>
                                    ...
                                    <div class="col-8">
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <div class="mt-2">
                                                    <label for="s_apply">申请人</label>
                                                    <div class="select2-primary">
                                                        <select class="select2-apply" name="s_apply[]" id="s_apply" multiple="multiple" data-placeholder="申请人筛选（放空等于全选）" data-dropdown-css-class="select2-primary" style="width: 100%;">
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="my-2">
                                                    <label for="s_verify">审核人</label>
                                                    <div class="select2-primary">
                                                        <select class="select2-verify" name="s_verify[]" id="s_verify" multiple="multiple" data-placeholder="审核人筛选（放空等于全选）" data-dropdown-css-class="select2-primary" style="width: 100%;">
                                                        </select>
                                                    </div>
                                                </div>
                                            </li>
...
<script src="<?= base_url('/'); ?>/plugins/inner/tyck/scr_report_index.js"></script>
<?php $this->endSection(); ?>