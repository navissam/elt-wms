                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <div class="custom-control custom-checkbox mt-1">
                                                    ...
                                                    <label for="ret_id" class="custom-control-label">退库编号</label>
                                                </div>
                                                <div class="custom-control custom-checkbox mt-1">
                                                    <input class="custom-control-input choose" type="checkbox" name="choosen[]" id="ret_date" value="ret_date">
                                                    <label for="ret_date" class="custom-control-label">退库日期</label>
                                                </div>
                                                <div class="custom-control custom-checkbox mt-1">
                                    ...
                                    <div class="col-8">
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <div class="mt-2">
                                                    <label for="s_ret_company">退库公司</label>
                                                    <div class="select2-primary">
                                                        <select class="select2-ret_company" name="s_ret_company[]" id="s_ret_company" multiple="multiple" data-placeholder="退库公司筛选（放空等于全选）" data-dropdown-css-class="select2-primary" style="width: 100%;">
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="mt-2">
                                                    <label for="s_ret_dept">退库部门</label>
                                                    <div class="select2-primary">
                                                        <select class="select2-ret_dept" name="s_ret_dept[]" id="s_ret_dept" multiple="multiple" data-placeholder="退库部门筛选（放空等于全选）" data-dropdown-css-class="select2-primary" style="width: 100%;">
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="my-2">
                                                    <label for="s_ret_name">退库人</label>
                                                    <div class="select2-primary">
                                                        <select class="select2-ret_name" name="s_ret_name[]" id="s_ret_name" multiple="multiple" data-placeholder="退库人筛选（放空等于全选）" data-dropdown-css-class="select2-primary" style="width: 100%;">
                                                        </select>
                                                    </div>
                                                </div>
                                            </li>
