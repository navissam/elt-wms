$(document).ready(function () {
    ...
    function reloadTable2() {
        ...
        let url = '/tyck/company/getDeleted';
        $.get(url, function (data, status) {
            let obj = JSON.parse(data);
            createTable2(obj);
            company2 = obj;
    ...
    $('#save').on('click', function () {
        ...
        $.ajax({
            url: '/tyck/company/save', // point to server-side PHP script
    ...
    $('#save-edit').on('click', function () {
        ...
        $.ajax({
            url: '/tyck/company/update', // point to server-side PHP script
            // dataType: 'json',  // what to expect back from the PHP script, if anything
            cache: false,
            contentType: false,
            processData: false,
