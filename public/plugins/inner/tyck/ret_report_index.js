$(document).ready(function () {
    ...
    $("#advfilter").on("click", function () {
        ...
        var err = false;
        c = 0;
        ($("#ret_id").prop("checked") == false) ? c = c + 1: null;
        ($("#ret_date").prop("checked") == false) ? c = c + 1: null;
        ...
        ($("#ret_location").prop("checked") == false) ? c = c + 1: null;
        ($("#ret_company").prop("checked") == false) ? c = c + 1: null;
        ($("#ret_dept").prop("checked") == false) ? c = c + 1: null;
        ($("#ret_name").prop("checked") == false) ? c = c + 1: null;
